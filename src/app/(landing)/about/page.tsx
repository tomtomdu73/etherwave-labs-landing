...
function Team({ members }: { members: AuthorType[] }) {
  return (
      ...
      <div className="space-y-24">
        <FadeInStagger>
          ...
          <div className="grid grid-cols-1 gap-6 pt-12 sm:pt-16 lg:grid-cols-4 xl:gap-8">
            <FadeIn>
              <h2 className="font-display text-2xl font-semibold text-neutral-950">Team</h2>
            </FadeIn>
...
export default async function About() {
  const articles = (await getPosts()).slice(0, 2) as Post[]
